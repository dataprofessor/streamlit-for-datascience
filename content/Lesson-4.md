...
In the previous lesson, we've explored how [Pandas](https://pandas.pydata.org/) can be used to perform data wrangling. In this lesson, we're going to take this a step further and take a look at how we can also use Pandas to explore the data.
